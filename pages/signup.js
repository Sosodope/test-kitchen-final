      ...
      <div className="max-w-md w-full">
        ...
        <form className="mt-8" action="#" method="POST">
          ...
          <div className="rounded-md shadow-sm">
            <div className='mb-2'>
              <input aria-label="Account Name" name="name" type="text" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5" placeholder="Account name" />
            </div>
            <div className='mb-2'>
